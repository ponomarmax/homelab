...
| `polar.device_battery` | `1.0` | Polar H10 | `unknown` | accepted | `packages/schemas/payloads/polar/polar.device_battery.v1.schema.json` | `packages/schemas/examples/payloads/polar.device_battery.v1.json` |

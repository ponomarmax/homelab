...
required_paths=(
  ...
  "infra/observability/config/grafana/provisioning/alerting/empty.yml"
  "infra/observability/config/grafana/provisioning/dashboards/baseline.yml"
  "infra/observability/config/grafana/provisioning/datasources/prometheus.yml"
  "infra/observability/config/grafana/provisioning/plugins/empty.yml"
  "infra/observability/config/grafana/dashboards/host/linux-server.json"
  "infra/observability/config/grafana/dashboards/containers/docker-containers.json"

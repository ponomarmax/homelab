...
if [[ "${CONFIRM_DEPLOY}" != "true" ]]; then
  ...
  echo "mkdir -p ${LOCAL_PROJECT_ROOT}/.deploy/services/wearable-pipeline-api"
  echo "mkdir -p ${LOCAL_PROJECT_ROOT}/.deploy/services/visualization"
  ...
  echo "cp -R ${LOCAL_PROJECT_ROOT}/services/wearable-pipeline-api/* ${LOCAL_PROJECT_ROOT}/.deploy/services/wearable-pipeline-api/"
  echo "cp -R ${LOCAL_PROJECT_ROOT}/services/visualization/* ${LOCAL_PROJECT_ROOT}/.deploy/services/visualization/"
...
mkdir -p "${LOCAL_PROJECT_ROOT}/.deploy/services/wearable-pipeline-api"
mkdir -p "${LOCAL_PROJECT_ROOT}/.deploy/services/visualization"
...
cp -R "${LOCAL_PROJECT_ROOT}/services/wearable-pipeline-api/." "${LOCAL_PROJECT_ROOT}/.deploy/services/wearable-pipeline-api/"
cp -R "${LOCAL_PROJECT_ROOT}/services/visualization/." "${LOCAL_PROJECT_ROOT}/.deploy/services/visualization/"

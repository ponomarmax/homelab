...
class AccSummaryHandler:
    name = "AccSummaryHandler"
    stream_type = "acc"
    ...
    def _empty_summary(self, generated_summary_path: str, source_paths: list[str], warnings: list[str]) -> HrSummaryOutput:
        summary = {
            ...
            "movement_activity": {
                "activity_energy_sum": None,
                "activity_energy_mean": None,
                "activity_energy_max": None,
            },
            "vector_magnitude": {
                "mean": None,
                "std": None,
    ...
    def handle(self, window_feature_paths: list[Path], generated_summary_path: str) -> HrSummaryOutput:
        ...
        for path in sorted(window_feature_paths):
            ...
            expected_columns = {
                ...
                "window_end_utc",
                "sample_count",
                "vector_magnitude_mean",
                "vector_magnitude_std",
                "vector_magnitude_max",
                "activity_energy",
            }
        ...
        numeric_columns = ["sample_count", "vector_magnitude_mean", "vector_magnitude_std", "vector_magnitude_max", "activity_energy"]
        ...
        anomaly_count = 0
        for column in ["vector_magnitude_mean", "vector_magnitude_std", "vector_magnitude_max", "activity_energy"]:
        ...
        summary = {
            ...
            "movement_activity": {
                "activity_energy_sum": _safe_float(analysis_df["activity_energy"].sum()),
                "activity_energy_mean": _safe_float(analysis_df["activity_energy"].mean()),
                "activity_energy_max": _safe_float(analysis_df["activity_energy"].max()),
            },
            "vector_magnitude": {
                "mean": _safe_float(analysis_df["vector_magnitude_mean"].mean()),
                "std": _safe_float(analysis_df["vector_magnitude_std"].mean()),
                "max": _safe_float(analysis_df["vector_magnitude_max"].max()),
            },
            "data_quality": {
                "status": data_quality,

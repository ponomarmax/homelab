...
SUPPORTED_SESSION_STREAMS = ("hr", "acc", "ecg", "battery", "ppi", "gyro", "mag", "ppg")
STREAM_KEY_BY_PAYLOAD_SCHEMA = {
    ...
    "polar.offline.hr": "hr",
    "polar.offline.acc": "acc",
    "polar.offline.ppi": "ppi",
    "polar.offline.gyro": "gyro",
    "polar.offline.mag": "mag",
    "polar.offline.ppg": "ppg",
}
